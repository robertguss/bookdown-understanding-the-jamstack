...
Now click on the "Hide Content" button in the "Members-only content" section. In this section we are going to make sure that users who do not have access to either membership plan cannot access the content.
...
3. Enter `login` for the "Access denied page." This will redirect users who try access the basic account page who are not logged in or who are not paying subscribers.
...
This tells memberstack to redirect the users who have a "premium plan" membership to the premium account page after signing up and after logging in.
...
## GitHub Repo
The completed project can be found here inside of `Eleventy-Membership/final` 
